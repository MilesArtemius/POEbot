...
def sayings():
    ...
    def generator(first_halves, second_halves):
        ...
        with open('/home/milty/POEbot/commands/sayings.txt', encoding='utf-8') as f:
            originals = f.read()
        codes = {
            'imperative': '{.+пов.+}',
            '1pl': '{.+V.+мн,изъяв,1-л}',
    ...
    with open('/home/milty/POEbot/commands/first_halves.txt', encoding='utf-8') as f:
        first_halves = f.read().split('\n')
    with open('/home/milty/POEbot/commands/second_halves.txt', encoding='utf-8') as f:
